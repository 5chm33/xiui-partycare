...
function M.createUserSettingsDefaults()
    return T{
        ...
        -- Optional PartyCare features embedded in XIUI's native party list.
        -- All spell actions are manual user clicks or mouse-wheel gestures.
        partyCare = T{
            enabled = false,
            hoverActionsEnabled = false,
            left = T{ enabled = false, spell = 'Cure IV' },
            right = T{ enabled = false, spell = 'Regen' },
            middle = T{ enabled = false, spell = 'Cure V' },
            mouse4 = T{ enabled = false, spell = 'Cure III' },
            mouse5 = T{ enabled = false, spell = 'Cure V' },
            wheelUp = T{ enabled = true, spell = 'Refresh' },
            wheelDown = T{ enabled = true, spell = 'Haste' },
            ...
            remedies = T{
                ...
                petrify = T{ spell = 'Stona', enabled = true, priority = 96 },
                curse = T{ spell = 'Cursna', enabled = true, priority = 95 },
                plague = T{ spell = 'Viruna', enabled = true, priority = 94 },
                disease = T{ spell = 'Viruna', enabled = true, priority = 93 },
                gravity = T{ spell = 'Erase', enabled = true, priority = 90 },
                bind = T{ spell = 'Erase', enabled = true, priority = 89 },
                slow = T{ spell = 'Erase', enabled = true, priority = 85 },
                silence = T{ spell = 'Silena', enabled = true, priority = 70 },
                blind = T{ spell = 'Blindna', enabled = true, priority = 60 },
                poison = T{ spell = 'Poisona', enabled = true, priority = 50 },
                bio = T{ spell = 'Erase', enabled = true, priority = 45 },
                dia = T{ spell = 'Erase', enabled = true, priority = 45 },
                addle = T{ spell = 'Erase', enabled = true, priority = 44 },
                flash = T{ spell = 'Erase', enabled = true, priority = 43 },
                stun = T{ spell = 'Erase', enabled = true, priority = 42 },
                elegy = T{ spell = 'Erase', enabled = true, priority = 40 },
                requiem = T{ spell = 'Erase', enabled = true, priority = 39 },
                helix = T{ spell = 'Erase', enabled = true, priority = 38 },
                elemental_dot = T{ spell = 'Erase', enabled = true, priority = 10 },
            },
        },
